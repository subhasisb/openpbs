...
job_purge(job *pjob)
{
	...
	tree_add_del(AVL_jobs, (void *)pjob->ji_qs.ji_jobid, (void *)pjob, TREE_OP_DEL);
...
resv_purge(resc_resv *presv)
{
	...
	tree_add_del(AVL_resvs_byid, (void *)presv->ri_qs.ri_resvID, (void *)presv, TREE_OP_DEL);
	tree_add_del(AVL_resvs_byqn, (void *)presv->ri_qs.ri_queue, (void *)presv, TREE_OP_DEL);

...
extern int decode_wire_AuthenResvPort(int socket, struct batch_request *);
extern int decode_wire_AuthExternal(int socket, struct batch_request *);
extern int decode_wire_CopyFiles(int socket, struct batch_request *);
extern int decode_wire_CopyFiles_Cred(int socket, struct batch_request *);
extern int decode_wire_JobCred(int socket, struct batch_request *);
extern int decode_wire_UserCred(int socket, struct batch_request *);
extern int decode_wire_UserMigrate(int socket, struct batch_request *);
extern int decode_wire_JobFile(int socket, struct batch_request *);
extern int decode_wire_CopyHookFile(int socket, struct batch_request *);
extern int decode_wire_DelHookFile(int socket, struct batch_request *);
extern int decode_wire_JobObit(int socket, struct batch_request *);
extern int decode_wire_Manage(int socket, struct batch_request *);
extern int decode_wire_MoveJob(int socket, struct batch_request *);
extern int decode_wire_MessageJob(int socket, struct batch_request *);
extern int decode_wire_ModifyResv(int socket, struct batch_request *);
extern int decode_wire_PySpawn(int socket, struct batch_request *);
extern int decode_wire_QueueJob(int socket, struct batch_request *);
extern int decode_wire_Register(int socket, struct batch_request *);
extern int decode_wire_RelnodesJob(int socket, struct batch_request *);
extern int decode_wire_ReqExtend(int socket, struct batch_request *);
extern int decode_wire_ReqHdr(int socket, struct batch_request *, int *tp, int *pv);
extern int decode_wire_Rescl(int socket, struct batch_request *);
extern int decode_wire_Rescq(int socket, struct batch_request *);
extern int decode_wire_Run(int socket, struct batch_request *);
extern int decode_wire_ShutDown(int socket, struct batch_request *);
extern int decode_wire_SignalJob(int socket, struct batch_request *);
extern int decode_wire_Status(int socket, struct batch_request *);
extern int decode_wire_TrackJob(int socket, struct batch_request *);
extern int decode_wire_replySvr(int socket, struct batch_reply *);
extern int decode_wire_svrattrl(int socket, pbs_list_head *);
extern int decode_wire_SchedCycleEnd(int sock, struct batch_request *preq);

extern int encode_wire_failover(int socket, struct batch_request *);
extern int encode_wire_CopyFiles(int socket, struct batch_request *);
extern int encode_wire_CopyFiles_Cred(int socket, struct batch_request *);
extern int encode_wire_JobObit(int socket, struct batch_request *);
extern int encode_wire_Register(int socket, struct batch_request *);
extern int encode_wire_TrackJob(int socket, struct batch_request *);
extern int encode_wire_reply(int socket, struct batch_reply *);
extern int encode_wire_replyRPP(int socket, char *, struct batch_reply *);
extern int encode_wire_svrattrl(int socket, svrattrl *);
extern int encode_wire_SchedCycleEnd(int sock, char *scname, int start_or_end);
